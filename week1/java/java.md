...
We can compile this code, using the Java compiler, into a *.class* file of the same name:
>javac Example.java

And to run the resulting `Example.class` file (please note that there is no file extension specified in this command):
>java Example
